...
This guide will walk you through creating your first event-sourced entity with Ventyd. We'll build a simple **User** entity that can be created and updated.

<Callout type="info">
**Prerequisites**

Make sure you've [installed Ventyd](/docs/getting-started/installation) and chosen a validation library before starting this guide.
</Callout>
...
The beauty of event sourcing: you have a complete audit trail!
...
//   { eventName: 'user:profile_updated', body: { bio: '...' } }
// ]
```
